<?php
/**
 * Acawiki Skin, based on MonoBook nouveau
 *
 ...
 * @addtogroup Skins
 */
class SkinAcawiki extends SkinTemplate {
	/** Using monobook. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'acawiki';
		$this->stylename = 'acawiki';
		$this->template  = 'AcawikiTemplate';
	}
}
 ...
 * @addtogroup Skins
 */
class AcawikiTemplate extends QuickTemplate {
	/**
...
<?php if($this->data['body_onload'    ]) { ?> onload="<?php     $this->text('body_onload')     ?>"<?php } ?>
 class="mediawiki <?php $this->text('nsclass') ?> <?php $this->text('dir') ?> <?php $this->text('pageclass') ?>">
	...
	<div id="content">
		...
		<h1 class="firstHeading"><?php $this->data['displaytitle']!=""?$this->html('title'):$this->html('title') ?></h1>
		<div id="bodyContent">
...
<?php
		foreach( array('contributions', 'log', 'blockip', 'emailuser') as $special ) {
			...
			if($this->data['nav_urls'][$special]) {
				?><li id="t-<?php echo $special ?>" class="acawiki-user-footer"><a href="<?php echo htmlspecialchars($this->data['nav_urls'][$special]['href'])
...
<!-- end of acawiki user footer -->
            ...
            <!--Acawiki content footer (comments, authors...)-->
		</div>
...
-->
	<div class="portlet" id="p-logo">
		<a href="<?php echo htmlspecialchars($this->data['nav_urls']['mainpage']['href'])?>" style="background-image: url(<?php $this->text('logopath') ?>);" <?php
			?><?php
...
<script type="text/javascript">
try {
var pageTracker = _gat._getTracker("UA-10289688-1");
